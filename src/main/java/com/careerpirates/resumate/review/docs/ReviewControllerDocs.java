...
public interface ReviewControllerDocs {
    ...
    SuccessResponse<?> deleteReview(@PathVariable Long id, @AuthenticationPrincipal CustomMemberDetails member);
    ...
    SuccessResponse<?> deleteReviewPermanently(@PathVariable Long id, @AuthenticationPrincipal CustomMemberDetails member);
    ...
    SuccessResponse<?> restoreReview(@PathVariable Long id, @RequestParam Long folderId, @AuthenticationPrincipal CustomMemberDetails member);
    ...
    SuccessResponse<ReviewResponse> getReview(@PathVariable Long id, @AuthenticationPrincipal CustomMemberDetails member);
    ...
    SuccessResponse<ReviewListResponse> getReviews(@ModelAttribute ReviewListRequest request, @AuthenticationPrincipal CustomMemberDetails member);
}
